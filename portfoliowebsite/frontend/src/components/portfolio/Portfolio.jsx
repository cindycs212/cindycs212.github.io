                    ...
                    {data.map((d) => (
                        ...
                        <li className='col-lg-4 col-md-6 col-sm-12' key={d.id}>
                            ...
                            <div className='project' id='project' data-bs-toggle='modal' data-bs-target='#myWebModal' onClick={() => setProject(d)}>
                                ...
                                <span className="text-center" id='stack'>{d.stack}</span>
                                {/* button doesn't contain link because the entire image is clickable. Button serves to tell user to click to view demo */}
