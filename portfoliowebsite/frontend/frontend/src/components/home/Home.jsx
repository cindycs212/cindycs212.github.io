...
export default function Home() {
    ...
    useEffect(() => {
        init(textRef.current, {
            showCursor: true,
            backDelay: 1500,
            strings: ['React', 'Python', 'Bootstrap']
        })
    })
    return (
        <div className='container-fluid px-0' id='home'>
            <div className='row'>
                <div className='col-md-5 order-2 order-md-1' id='left'>
                    <img src="/imgs/insertBlock.svg" alt="picture" />
                    <a className='credit' href="https://storyset.com/online">Online illustrations by Storyset</a>
                </div>
                <div className='col-md-6 col-sm-11 order-1 order-md-2' id='right'>
